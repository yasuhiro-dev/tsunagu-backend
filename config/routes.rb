Rails.application.routes.draw do
  ...
  namespace :api do
    namespace :v1 do
      ...
      post "/meeting_slots", to: "meeting_slots#create"
      ...
      get "/family_availabilities", to: "family_availabilities#index"
      post "/family_availabilities", to: "family_availabilities#create"
      delete "/family_availabilities/:meeting_slot_id", to: "family_availabilities#destroy", as: "family_availability_meeting_slot"
      patch "/family_availabilities", to: "family_availabilities#update", as: "family_availability_family"
      get "/schedules/current", to: "schedules#current"
      post "/schedules/:id", to: "schedules#create"
