...
ActiveRecord::Schema[8.1].define(version: 2026_03_14_131757) do
  create_table "assignments", force: :cascade do |t|
    ...
    t.index ["interview_slot_id"], name: "index_assignments_on_interview_slot_id"
  end
  ...
  create_table "family_unavailabilities", force: :cascade do |t|
    ...
    t.index ["interview_slot_id"], name: "index_family_unavailabilities_on_interview_slot_id"
  end
  ...
  create_table "interview_slots", force: :cascade do |t|
    ...
    t.integer "teacher_id", null: false
    t.datetime "updated_at", null: false
    t.index ["schedule_id"], name: "index_interview_slots_on_schedule_id"
    t.index ["teacher_id"], name: "index_interview_slots_on_teacher_id"
  end
  ...
  add_foreign_key "assignments", "interview_slots"
  ...
  add_foreign_key "family_unavailabilities", "interview_slots"
  add_foreign_key "interview_slots", "schedules"
  add_foreign_key "interview_slots", "teachers"
end
